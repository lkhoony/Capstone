  ...
  <div>
    <div>
      ...
      <b-row align-v="stretch">
        ...
        <b-col cols="12" md="2">
            <b-button size="lg" variant="primary" style="height:60%;width:60%" v-on:click="createPlot">조회</b-button>
        </b-col>

    </b-row>

    <div class="row">
        <div id="input_data_plot_box" style="width : 100%"></div>
    </div>
      ...
      createPlot(){
        ...
        $.ajax({
          ...
          success: function (data) {
            console.log(data);
            Plotly.newPlot('input_data_plot_box', [data]);
          }
        });
      }
    },
